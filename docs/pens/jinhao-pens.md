...
The first Jinhao pen I got is the Baoer 801 Silver Steel, which is also known as the Jinhao 801. Baoer is a sub-brand of Jinhao, so they share a similar look and feel. It’s an everyday pen. Before buying the Wing Sung 3010, I used it every day. In general, it’s smooth with no skipping. It may hard-start if I don’t use it for a long time.

The second one is the Jinhao 65 Black with an extra-fine (EF) nib. I bought it because I wanted an EF nib that is compatible with Lamy nibs. It’s kind of okay, but I prefer using the Baoer 801 or Wing Sung 3010.
